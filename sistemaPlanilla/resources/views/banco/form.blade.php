...
<div class="modal-header bg-primary">
    <h4 class="modal-title" id="modalCrearProfesionTitle">{{ $mode == 'create' ? 'Agregar Banco'  : 'Modificar Banco' }}</h5>
...
<div class="modal-body">
    ...
    <div class="col-sm-9 pb-2">
        @if ($mode == 'create')        
            ...
            <input type="text" class="form-control" name="nombreBanco" id="nombreBanco" value="{{ old('nombreBanco') }}" required />
            ...
            @else
            <input type="text" class="form-control" name="nombreBanco" id="nombreBanco"  required />
            @endif
        @else
        <input type="text" class="form-control" name="nombreBanco" id="nombreBanco" value="{{ old('nombreBanco') }}" required />
            @if (count($errors) > 0 && Session::get('peticion') != 'crear')
