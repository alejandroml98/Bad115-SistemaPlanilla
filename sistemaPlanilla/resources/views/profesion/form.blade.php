...
<div class="modal-body">
    ...
    <div class="col-sm-9 pb-2">
        @if ($mode == 'create')        
            ...
            <input type="text" class="form-control" name="nombreProfesion" id="nombreProfesionCreate" value="{{ old('nombreProfesion') }}" required />
            ...
            @else
            <input type="text" class="form-control" name="nombreProfesion" id="nombreProfesionCreate" required />
            @endif
        @else
        <input type="text" class="form-control" name="nombreProfesion" id="nombreProfesion" value="{{ old('nombreProfesion') }}" required />
            @if (count($errors) > 0 && Session::get('peticion') != 'crear')
